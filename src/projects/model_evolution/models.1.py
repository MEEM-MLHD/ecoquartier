...
class Project(models.Model):
    ...
    statut_link = models.ForeignKey(Statut, null=True)
    zonage_insee = models.TextField()
    zonage_insee_link = models.ForeignKey(ZonageINSEE, null=True)
    commune = models.TextField()
    commune_link = models.ForeignKey(Commune, null=True)
    code_insee = models.TextField()
    population = models.TextField()
    departement = models.TextField()
    departement_link = models.ForeignKey(Departement, null=True)
    region = models.TextField()
    region_link = models.ForeignKey(Region, null=True)
    description = models.TextField()
    contexte_commune = models.TextField()
    contexte_commune_link = models.ForeignKey(ContexteCommune, null=True)
    ...
    coordonnees_geographiques = models.TextField()
    site = models.TextField()
    contexte_site = models.TextField()
    type_operation = models.TextField()
    type_operation_link = models.ForeignKey(TypeOperation, null=True)
    type_operation_autre = models.TextField()
    vocation = models.TextField()
    vocation_link = models.ForeignKey(Vocation, null=True)
    ...
    label_ecoquartier = models.TextField()
    label_ecoquartier_link = models.ForeignKey(LabelEcoQuartier, null=True)
    annee_label = models.TextField()
    procedure = models.TextField()
    procedure_link = models.ForeignKey(Procedure, null=True)
